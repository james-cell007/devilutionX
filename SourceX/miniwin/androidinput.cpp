...
void RenderJoyStick(int X , int Y , SDL_Rect *JoystickCircleRect ){
	    JoystickCircleRect->x = 50;
		JoystickCircleRect->y = 50;
		JoystickCircleRect->w = 200;
		JoystickCircleRect->h = 200;
