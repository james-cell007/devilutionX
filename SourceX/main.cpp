...
if ( FileExists("/sdcard/devilutionx/change_controls.png") == false) {
	const int dir_errbzx = system("cp  /sdcard/change_controls.png /sdcard/devilutionx/");
	if (-1 == dir_errbzx) {
		printf("Error copying change_controls.png \n");
		exit(1);
	}
}
...
if ( FileExists("/sdcard/devilutionx/JoystickCircle.png") == false) {
	...
	if (-1 == dir_errbzxc) {
		printf("Error copying JoystickCircle.png \n");
		exit(1);
	}
}
